...
public class ACHRecord {
    ...
    protected String spaceFill(int nbrSpaces) {
        ...
        for (int i = 0; i < nbrSpaces; i++) {
            stringBuilder.append(ApplicationConstant.ONE_LENGTH_STRING);
        }
