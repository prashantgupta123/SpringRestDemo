            ...
            while (record != null) {
                ...
                for (int recStart = 0; recStart < record.length(); recStart += recLength) {
                    ...
                    if (achRecord.isFileHeaderType()) {
                        System.out.println("achRecord.isFileHeaderType()");
                        ...
                        System.out.println("achRecord.isFileControlType()");
                        if (achEntry != null) {
                            achEntry = null;
                        ...
                        System.out.println("achRecord.isBatchHeaderType()");
                        if (achEntry != null) {
                            achBatch.addEntryRecs(achEntry);
                            achEntry = null;
                        }
                        ...
                        System.out.println("achRecord.isBatchControlType()");
                        if (achEntry != null) {
                            achBatch.addEntryRecs(achEntry);
                            achEntry = null;
                        }
                        ...
                        System.out.println("achRecord.isEntryDetailType()");
                        if (achEntry != null) {
                            achBatch.addEntryRecs(achEntry);
                            achEntry = null;
                        }
                        ...
                        System.out.println("achRecord.isAddendaType()");
                        if (achEntry == null) {
                            achEntry = new ACHEntry();
                        }
